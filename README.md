...
[![STARTcloud Roles logo](https://raw.githubusercontent.com/STARTcloud/startcloud_roles/refs/heads/main/roles/startcloud_theme/files/github-header.svg)](https://github.com/STARTcloud/startcloud_roles/)

Documentation for STARTcloud Roles

[**Explore the docs »**](https://github.com/STARTcloud/startcloud_roles/)

[Report Bug](https://github.com/STARTcloud/startcloud_roles/issues) ·
[Request Feature](https://github.com/STARTcloud/startcloud_roles/issues)
...
The collection ships 140 roles covering base system setup, services, databases,
desktops, and appliance targets — browse them under [roles/](roles/). Every
role carries its own `README.md` describing what it does and a
`meta/argument_specs.yml` documenting every variable it accepts.
